...
def client(msg, log_buffer=sys.stderr):
    ...
    sock_client = socket.socket(socket.AF_INET, socket.SOCK_STREAM, socket.IPPROTO_TCP)
    ...
    try:
        ...
        sock_client.send(msg.encode('utf-8'))
        ...
        while True:
            ...
            if len(chunk) < 16:
                print(f"Full message received. The message is '{received_message}'")
                break
